  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        ...
        >
          <Copyright className='w-3 h-3 sm:mr-1' />
          <span className='hidden sm:inline'>© 2025 White Rabbit</span>
        </Button>
      </DialogTrigger>
          ...
          <div className='space-y-4 text-sm'>
            ...
            <div>
              ...
              <p className='text-muted-foreground'>
                This software is licensed for personal, educational, and
                non-commercial use. You may use, modify, and create derivative
                works for personal purposes only.
              </p>
            </div>
            ...
            <div className='bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg border border-yellow-200 dark:border-yellow-800'>
              ...
              <p className='text-yellow-700 dark:text-yellow-300'>
                Commercial use of this software requires a separate commercial
                license. This includes use within commercial organizations,
                integration into commercial products, or any use to generate
                revenue.
              </p>
            </div>
            ...
            <div>
              ...
              <p className='text-muted-foreground'>
                All copies and derivative works must retain the copyright notice
                and include:
                <br />
            ...
            <div>
              ...
              <p className='text-muted-foreground'>
                "White Rabbit" and associated logos are trademarks of White
                Rabbit Team. Use of these trademarks requires explicit written
                permission.
              </p>
            </div>
            ...
            <div className='bg-muted p-4 rounded-lg'>
              ...
              <p className='text-muted-foreground mb-2'>
                For commercial use, enterprise licenses, or custom licensing
