  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Publish to Vercel</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <Input id="vercel-token" value={apiToken} onChange={(e) => setApiToken(e.target.value)} placeholder="VERCEL_API_TOKEN" />
          ...
          {deployUrl && (
            <div className="rounded border p-3 space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Input readOnly value={deployUrl} />
                <Button variant="outline" asChild>
                  <a href={deployUrl} target="_blank" rel="noopener noreferrer"><ExternalLink className="w-4 h-4" /></a>
                </Button>
              </div>
