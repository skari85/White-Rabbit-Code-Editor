      ...
      <header className='border-b border-zinc-800 bg-zinc-950/80 backdrop-blur-sm'>
        <div className='flex justify-between items-center p-6 max-w-7xl mx-auto'>
          <div className='flex items-center'>
            ...
            <span className='text-gray-100 font-mono text-sm tracking-wider'>
              WHITE RABBIT
            </span>
          </div>
          <div className='flex items-center space-x-6'>
            <Link
              href='/setup'
              className='text-gray-400 hover:text-gray-200 transition-colors text-sm font-mono'
            >
              setup
            </Link>
            <Link
          ...
          <div className='space-y-8'>
            <div className='space-y-6'>
              ...
              <p className='text-lg text-gray-400 leading-relaxed font-mono'>
                a visual code editor that helps you create web applications
                faster. perfect for developers who want AI assistance without
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
              <Link href='/enter'>
                <Button
                  size='lg'
                  className='bg-zinc-800 hover:bg-zinc-700 text-gray-100 border border-zinc-700 font-mono text-sm px-8 py-4'
                >
                  start building
                </Button>
              </Link>
              <Link href='/visual-tools'>
                <Button
                  size='lg'
                  variant='outline'
                  className='border-zinc-700 text-gray-400 hover:bg-zinc-800 hover:text-gray-200 font-mono text-sm px-8 py-4'
                >
                  see the tools
                </Button>
              </Link>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            ...
            <div className='border border-zinc-800 rounded-lg p-6 bg-zinc-900/30'>
              ...
              <p className='text-xs text-gray-500 font-mono leading-relaxed'>
                get code suggestions, generate components, and receive
                intelligent debugging help powered by advanced AI
              </p>
            </div>
            ...
            <div className='border border-zinc-800 rounded-lg p-6 bg-zinc-900/30'>
              ...
              <p className='text-xs text-gray-500 font-mono leading-relaxed'>
                see your code structure, track changes visually, and understand
                your project's architecture at a glance
              </p>
            </div>
            ...
            <div className='border border-zinc-800 rounded-lg p-6 bg-zinc-900/30'>
              ...
              <p className='text-xs text-gray-500 font-mono leading-relaxed'>
                build, test, and deploy your web applications with integrated
                tools and instant preview capabilities
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='max-w-7xl mx-auto px-6 py-16'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto'>
            <div className='text-center'>
              <h3 className='text-lg font-mono text-gray-300 mb-3'>
                visual-first approach
              </h3>
              <p className='text-sm text-gray-500 font-mono leading-relaxed'>
                instead of memorizing complex commands, use visual tools to
            ...
            <div className='text-center'>
              ...
              <p className='text-sm text-gray-500 font-mono leading-relaxed'>
                get relevant code suggestions and intelligent assistance without
            ...
            <div className='text-center'>
              ...
              <p className='text-sm text-gray-500 font-mono leading-relaxed'>
                start coding immediately. no setup, no complex configuration,
            ...
            <div className='text-center'>
              ...
              <p className='text-sm text-gray-500 font-mono leading-relaxed'>
                built-in sharing and collaboration features for teams working on
                web projects together
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='max-w-7xl mx-auto px-6 py-8'>
          <div className='text-center'>
            <p className='text-gray-500 font-mono text-xs'>
              &copy; 2025 white rabbit. all rights reserved.
            </p>
